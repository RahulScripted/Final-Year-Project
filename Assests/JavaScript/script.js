function loco(){
    ...
    getBoundingClientRect() {
        return {top: 0, left: 0, width: window.innerWidth, height: window.innerHeight,smooth: true};
    },
...
const h1Text = new SplitType("#h1Text");
tl.from('.char',{
    y : 50,
    opacity : 0,
    duration : 0.7,
...
tl.from('#pText, .generate-btn-home span',{
  y : 50,
  opacity : 0,
  duration : 0.6,
  stagger : 0.08,
